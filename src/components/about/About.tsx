    ...
    return(
        <div className='flex 3xs:flex-col md:flex-row'>
            ...
            <div id='second' className='flex flex-col relative border-[6px] border-[#112C03] bg-[#c2e2d5] rounded-lg h-[62vh] 3xs:w-[65vw] md:w-[40vw] 3xs:left-[20vw] md:left-[2vw] 3xs:-top-[7vh] md:top-[17vh] justify-center items-center'>
                <div className='3xs:w-[60vw] relative md:w-[38vw] 3xs:h-[30vh] 3xs:-top-[3vh] sm/md:-top-[8vh]'>
                ...
                <br></br>
                <div className="flex sm/md:flex-row relative 3xs:flex-col 3xs:pl-[1vw] lg:pl-[4vw] items-center 3xs:space-x-[1vw] lg:space-x-[2vw] sm/md:top-[8vh] 3xs:top-[4vh] sm/md:space-y-[0vh] 3xs:space-y-[2vh]">
                    <h3 className="font-semibold 3xs:text-[3vw] sm:text-[.9rem] lg:text-[1rem] 2xl:text-[1.2rem] text-[#0c331f] leading-tight">317-784-1614</h3>
                    <div className="rounded-full relative h-[2vh] w-[1vw] bg-[#0c331f]"></div>
                    <h3 className="font-semibold 3xs:text-[3vw] sm:text-[.9rem] lg:text-[1rem] 2xl:text-[1.2rem]] text-[#0c331f] leading-tight">2636 East St Indianapolis, IN 46225</h3>
                </div>
            </div>
        </div>
    )
